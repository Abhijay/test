...
(async () => {
  ...
  try {
    // Navigate to the simulated Infotracer opt-out page
    await page.goto('http://localhost:8000/infotracer_optout.html');
    ...
    console.log('Filled in the Infotracer opt-out form with placeholder values.');
  } catch (error) {
